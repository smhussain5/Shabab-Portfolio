...
function App() {
  return (
    <div className="flex flex-col">
      {/* NAVBAR */}
      <div className="navbar h-16 shadow" id="nav">
        <div className="navbar-start">
          <div className="dropdown">
            <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
            </div>
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box bg-zinc-50 w-52 font-['Poppins']">
              <li><a className="transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="#sectionAbout">About</a></li>
              <li><a className="transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="#sectionTools">Tools</a></li>
              <li><a className="transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="#sectionShowcase">Showcase</a></li>
            </ul>
          </div>
          <a className="btn btn-ghost text-xl font-['Poppins'] font-bold uppercase transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="/">Shabab</a>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 font-['Poppins'] uppercase font-semibold">
            <li><a className="transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="#sectionAbout">About</a></li>
            <li><a className="transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="#sectionTools">Tools</a></li>
            <li><a className="transition duration-500 ease-in-out hover:text-lime-500 hover:bg-zinc-900" href="#sectionShowcase">Showcase</a></li>
          </ul>
      ...
      <section id="sectionHero">
        <div className="hero h-screen" style={{ backgroundImage: "url(/Binary_001.png)" }}>
          <div className="hero-overlay bg-zinc-900 bg-opacity-75"></div>
          <div className="hero-content">
            <div className="max-w-md">
              <div className="mockup-code bg-zinc-950 bg-opacity-65 text-left text-zinc-200 drop-shadow-md">
                <pre data-prefix=">"><code>print("Hello World!")</code></pre>
                <pre data-prefix=">" className="bg-lime-400 text-zinc-950"><code>name = "Shabab"</code></pre>
                <pre data-prefix=">"><code>role = "Full-Stack SWE"</code></pre>
                <pre data-prefix=">"><code>specialty = "Python"</code></pre>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ABOUT */}
      <section className="p-6" id="sectionAbout">
        <h1 className="mb-4">ABOUT</h1>
        <div className="grid grid-cols-12 gap-2">
          <div className="col-span-full my-0 md:col-span-3">
            <figure>
              <img src="/SH_HEADSHOT.png" alt="Shabab Headshot" className="mask mask-squircle" />
            </figure>
          </div>
          <div className="m-2 grid grid-rows-6 col-span-full gap-2 md:col-span-9 md:m-2">
            <p className="row-span-full text-left">
              My passion for software engineering spans almost a decade! From editing my Tumblr's HTML/CSS during high school to developing data analytic tools for a hospital during my master's degree, programming has always found its way into my life. Although I enjoy most aspects of the field, I'm mostly interested in full-stack development with Python. Feel free to contact me on any of the social media links below or just have a look around my portfolio!
            </p>
            <div className="row-span-2">
              <ul className="menu bg-zinc-900 w-full rounded-box">
                <ul>
                  <li><a href="mailto:smhussain5@proton.me" target="_blank">
                    <svg width={16} fill="#6D4AFF" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Proton Mail</title><path d="m15.24 8.998 3.656-3.073v15.81H2.482C1.11 21.735 0 20.609 0 19.223V6.944l7.58 6.38a2.186 2.186 0 0 0 2.871-.042l4.792-4.284h-.003zm-5.456 3.538 1.809-1.616a2.438 2.438 0 0 1-1.178-.533L.905 2.395A.552.552 0 0 0 0 2.826v2.811l8.226 6.923a1.186 1.186 0 0 0 1.558-.024zM23.871 2.463a.551.551 0 0 0-.776-.068l-3.199 2.688v16.653h1.623c1.371 0 2.481-1.127 2.481-2.513V2.824a.551.551 0 0 0-.129-.36z" /></svg>
                    Proton Mail
                  </a></li>
                  <li><a href="https://github.com/smhussain5" target="_blank">
                    <svg width={16} fill="#e4e4e7" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" /></svg>
                    GitHub
                  </a></li>
                  <li><a href="https://www.linkedin.com/in/shabab-h/" target="_blank">
                    <svg width={16} fill="#0A66C2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn</title><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                    LinkedIn
                  </a></li>
                  <li><a href="https://twitter.com/shussain_5" target="_blank">
                    <svg width={16} fill="#e4e4e7" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>X</title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" /></svg>
                    X (Twitter)
                  </a></li>
                </ul>
              </ul>
      ...
      < section className="p-6" id="sectionShowcase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              <figure><img src="/project_images/FLASKY_CHAT_PYTHON_LI.gif" alt="Flasky Chat GIF" /></figure>
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Poppins'] font-bold">Flasky Chat</h2>
                <p className="text-xs sm:text-sm">
                  This full-stack real-time chat application uses Flask, JavaScript, Python, and SocketIO. Create your own chat-room or join a friend using their unique 4-character chat-room code!
                  <br />
                  <br />
                  Read more details in the GitHub README linked below!
                </p>
                <div className="card-actions join gap-0">
                  <a href="https://github.com/smhussain5/Flask-SocketIO-Chat-Python" className="join-item btn btn-sm" target="_blank">
                    <svg width={16} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" /></svg>
                    GitHub
                  </a>
                  <a href="https://flasky-chat-830ac03d48e2.herokuapp.com/" className="join-item btn btn-sm btn-primary" target="_blank">Live Demonstration</a>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              <figure><img src="/project_images/POLITICO_NLP_PYTHON.gif" alt="Politico NLP GIF" /></figure>
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Poppins'] font-bold">Politico Web Scraper</h2>
                <p className="text-xs sm:text-sm">
                  This command-line interface uses Beautiful Soup to scrape article data from Politico's website. Scraped data is then summarized with a final polarity score using natural language processing (NLP) libraries.
                  <br />
                  <br />
                  Read more details in the GitHub README linked below!
                </p>
                <div className="card-actions join gap-0">
                  <a href="https://github.com/smhussain5/Politico-NLP-Python" className="join-item btn btn-sm" target="_blank">
                    <svg width={16} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" /></svg>
                    GitHub
                  </a>
                </div>
          ...
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              <figure><img src="/project_images/ATM_PYTHON.gif" alt="ATM GIF" /></figure>
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Poppins'] font-bold">Automatic Teller Machine (ATM)</h2>
                <p className="text-xs sm:text-sm">
                  This command-line interface uses object-oriented programming (OOP) to simulate an ATM. Users are given $5000 in their checking and savings account with which they can deposit, transfer, or withdraw funds.
                  <br />
                  <br />
                  Read more details in the GitHub README linked below!
                </p>
                <div className="card-actions join gap-0">
                  <a href="https://github.com/smhussain5/ATM-OOP" className="join-item btn btn-sm" target="_blank">
                    <svg width={16} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" /></svg>
                    GitHub
                  </a>
                </div>
      ...
      {/* FOOTER */}
      < footer className="footer justify-center p-4 w-full text-zinc-600 shadow h-16" >
