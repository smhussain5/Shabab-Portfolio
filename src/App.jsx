...
function App() {
  return (
    <div className="flex flex-col">
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box bg-zinc-50 w-52 font-['Poppins']">
              <li><a className="transition duration-500 ease-in-out hover:text-blue-500 hover:bg-zinc-100 hover:scale-105">About</a></li>
              <li><a className="transition duration-500 ease-in-out hover:text-blue-500 hover:bg-zinc-100 hover:scale-105">Tools</a></li>
              <li><a className="transition duration-500 ease-in-out hover:text-blue-500 hover:bg-zinc-100 hover:scale-105">Showcase</a></li>
            </ul>
          </div>
          <a className="btn btn-ghost text-xl font-['Poppins'] font-bold uppercase">Shabab</a>
        </div>
      ...
      {/* HERO */}
      <section>
        <div className="hero h-screen" style={{ backgroundImage: "url(/Binary_004.png)" }}>
          ...
          <div className="hero-content">
            <div className="max-w-md">
              <div className="mockup-code bg-zinc-100 bg-opacity-65 text-left text-zinc-950 drop-shadow-md">
                ...
                <pre data-prefix=">" className="bg-blue-200 text-zinc-950"><code>name = "Shabab"</code></pre>
      ...
      <section className="p-6">
        ...
        <div className="grid grid-cols-12 gap-2">
          <div className="col-span-full my-auto md:col-span-3">
            <figure>
          ...
          <div className="m-2 grid grid-rows-6 col-span-full gap-2 md:col-span-9 md:m-2">
            <p className="row-span-full text-left">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo officia nulla asperiores modi corporis similique officiis beatae laboriosam dolore! Aperiam, nemo consequatur libero esse vel quam consectetur voluptatum blanditiis itaque ea temporibus quae ut rerum quas! Similique, culpa ea dolore vero officia libero commodi animi magnam in natus error harum.
            </p>
            <div className="row-span-2">
              <ul className="menu rounded-box border">
                <li>
                  <details open>
                    <summary>Socials</summary>
                    <ul>
                      <li><a href="mailto:smhussain5@proton.me" target="_blank">Proton Mail</a></li>
                      <li><a href="https://github.com/smhussain5" target="_blank">GitHub</a></li>
                      <li><a href="https://www.linkedin.com/in/shabab-h/" target="_blank">LinkedIn</a></li>
                      <li><a href="https://twitter.com/shussain_5" target="_blank">X (Twitter)</a></li>
                    </ul>
                  </details>
                </li>
              </ul>
      ...
      < section className="p-6" >
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-12 place-items-center gap-4">
          <div className="bg-zinc-100 p-4 rounded-box shadow-blue-500/50 shadow-md">
      ...
      < section className="p-6" >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
          ...
          <div className="flex flex-col">
            <div className="card w-full shadow-md">
              ...
              <div className="card-body flex flex-col text-left p-4">
                ...
                <small>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur, quae?</small>
                <div className="card-actions join gap-0">
                  <a href="https://github.com/smhussain5/ATM-OOP" className="join-item btn btn-sm btn-outline btn-neutral" target="_blank">GitHub</a>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col">
            <div className="card w-full shadow-md">
              <figure><img src="/project_images/POLTICO_NLP_PYTHON.gif" alt="POLITICO NLP PYTHON" /></figure>
              <div className="card-body flex flex-col text-left p-4">
                <h2 className="card-title">Politico NLP</h2>
                <small>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur, quae?</small>
                <div className="card-actions join gap-0">
