  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="navbar h-16 shadow" id="nav">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box bg-zinc-50 w-52 font-['Ubuntu']">
              <li><a className="transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="#sectionAbout">About</a></li>
              <li><a className="transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="#sectionTools">Tools</a></li>
              <li><a className="transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="#sectionShowcase">Showcase</a></li>
            </ul>
          </div>
          <a className="btn btn-ghost text-xl font-['Ubuntu'] font-bold uppercase transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="/">Shabab</a>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 font-['Ubuntu'] uppercase font-semibold">
            <li><a className="transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="#sectionAbout">About</a></li>
            <li><a className="transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="#sectionTools">Tools</a></li>
            <li><a className="transition duration-500 ease-in-out hover:text-sky-500 hover:bg-zinc-100 hover:scale-105" href="#sectionShowcase">Showcase</a></li>
          </ul>
        ...
        <div className="navbar-end">
          <button className="btn btn-primary font-['Ubuntu'] uppercase font-semibold">
            Resume
          </button>
        </div>
      </div>
      ...
      <section id="sectionHero">
        <div className="hero h-screen" style={{ backgroundImage: "url(/Binary_002.png)" }}>
          <div className="hero-overlay bg-zinc-100 bg-opacity-75"></div>
          <div className="hero-content">
            <div className="max-w-md">
              <div className="mockup-code bg-zinc-100 bg-opacity-65 text-left text-zinc-950 drop-shadow-md">
                <pre data-prefix=">"><code>print("Hello World!")</code></pre>
                <pre data-prefix=">" className="bg-sky-200 text-zinc-950"><code>name = "Shabab"</code></pre>
              ...
              <ul className="menu bg-zinc-100 w-full rounded-box">
                <ul>
                  ...
                  <li><a href="https://www.linkedin.com/in/shabab-h/" target="_blank">
                    <svg width={16} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn</title><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                    LinkedIn
                  </a></li>
                  <li><a href="https://twitter.com/shussain_5" target="_blank">
                    <svg width={16} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>X</title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" /></svg>
                    X (Twitter)
                  </a></li>
                </ul>
              </ul>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              ...
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Ubuntu'] font-bold">DocFinder</h2>
          ...
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              ...
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Ubuntu'] font-bold">Flasky Chat</h2>
                <p className="text-xs sm:text-sm">
          ...
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              ...
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Ubuntu'] font-bold">Politico Web Scraper</h2>
                <p className="text-xs sm:text-sm">
          ...
          <div className="flex flex-col">
            <div className="card w-full shadow-lg image-full card-compact">
              ...
              <div className="card-body flex flex-col text-left">
                <h2 className="card-title font-['Ubuntu'] font-bold">Automatic Teller Machine (ATM)</h2>
                <p className="text-xs sm:text-sm">
